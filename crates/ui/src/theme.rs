...
/// this every frame, resolving the system appearance and any explicit
/// preference, so widgets built during that render (and canvas paint
/// callbacks after it) all agree.
...
pub const TOUCH_METRICS: Metrics = Metrics {
    ...
    menu_w: 280.0,
    options_bar_h: 48.0,
    // A 44pt close target plus the strip's bottom border.
    tab_h: 45.0,
    tab_close: 44.0,
    tab_close_icon: 18.0,
    status_h: 30.0,
