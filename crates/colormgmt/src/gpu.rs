//! Matrix/TRC RGB profiles and all CMS-supported CICP transfer curves.
//! CLUT profiles retain the CMS executor.
use moxcms::{ColorProfile, DataColorSpace, ToneReprCurve};
use schist_fx::{ComputeProgram, ComputeShader};
static SHADER: ComputeShader = ComputeShader::new("icc-matrix-trc", include_str!("gpu.wgsl"));
